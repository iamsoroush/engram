...
Engram is a capture-first clinical memory tool. A doctor must never be forced to select a patient before capturing audio, photo, or text. Capture must remain available even when syncing, processing, patient assignment, or organization is delayed.
