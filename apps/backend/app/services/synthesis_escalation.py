"""Correction-triggered synthesis escalation (escalation-tier decision — see docs/technical-decisions/2026-07-05-treatment-overlay-schema-v2.md; deferred from Wave 2).
