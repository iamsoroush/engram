...
def normalize_bcp47_lang(value: Any) -> str | None:
    ...
    reference field a future language-switch migration reads (the ai-engine refactor decision, docs/technical-decisions/2026-07-04-ai-engine-pipeline-hardening.md). Our inputs are already BCP-47-ish (``fa``, ``en``, ``fa-IR``); sentinels that name no single
