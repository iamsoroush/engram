"""Every job output envelope stamps its contract ``OUTPUT_VERSION`` as ``schemaVersion`` (§2.2).

Provenance the backend/eval can key regressions on. Additive: the field is new, never removed a key.
"""
import unittest
