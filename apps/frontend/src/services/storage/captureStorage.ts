 ...
 * Version 3 owns pending uploads, cached source blobs, and local/backend ID maps.
 */
...
export async function clearLocalCaptureData() {
  ...
  return new Promise<void>((resolve, reject) => {
    const transaction = db.transaction([OUTBOX_STORE, CACHE_STORE, ID_MAPPING_STORE], "readwrite");
